...
- prepare the next session search and maintenance slices
...
- the API can evolve from stable route and schema contracts without breaking the review, wiki, and instructor workflows
